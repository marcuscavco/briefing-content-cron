...
|---|---|---|---|---|
| 1 | The Information | https://www.theinformation.com | `https://$THE_INFORMATION_EMAIL:$THE_INFORMATION_PASSWORD@www.theinformation.com/subscriber_feed` (Basic Auth) | Scoops de big tech, IA, VC |
